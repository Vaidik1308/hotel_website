  ...
  return (
    ...
    <div>
        ...
        <div className='container mx-auto mt-20'>
          <div className='md:grid md:grid-cols-12 gap-18 px-3'>
            <div className='md:col-span-8 md:w-full'>

              {/* HOTEL INFORMATION */}
              <div>
                <h2 className='font-bold text-left text-lg md:text-2xl'>{room.name} ({room.dimension})</h2>
                ...
                <div className='mb-11'>
                  ...
                  <div className='grid grid-cols-2'>
                    {room.offeredAmenities.map((amenity) => (
                      <div key={amenity._key} className='flex items-center gap-1 md:my-0 my-1'>
